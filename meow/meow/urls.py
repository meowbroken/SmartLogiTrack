...
from supplyChainAPI.views import InventoryCreateView, InventoryDetailView, OrderCreateView, OrderDetailView, SupplierDetailView, SuppliersCreateView, ForecastCreateView, ForecastDetailView, ForecastPredictionView, SupplierPartnerOrderReceiver, InquiryEmailView, feedback_sentiment_view, RegisterView, UnansweredChatListView,ChatInteractionReplyView, check_chat_reply
...
urlpatterns = [
    ...
    path('feedback/sentiment/', feedback_sentiment_view, name='feedback-sentiment'),
    path('chat/unanswered/', UnansweredChatListView.as_view(), name='unanswered-chats'),
    path('chat/reply/<int:pk>/', ChatInteractionReplyView.as_view(), name='chat-reply'),
    path('api/check-reply/<int:interaction_id>/', check_chat_reply, name='check-chat-reply'),
]
